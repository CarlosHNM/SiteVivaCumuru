...
namespace VivaCumuru.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TelId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TelNome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TelNum = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelefoneUteis", x => x.TelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlLocalizador = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loja_SubCategoria_SubCategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TbAnexoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBAnexo", x => x.TbAnexoId);
                    table.ForeignKey(
                        name: "FK_TBAnexo_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
