...
namespace VivaCumuru.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public AdminImagensController(IWebHostEnvironment hostingEnvironment,
            IOptions<ConfigurationImagens> myConfiguration, AppDbContext context)
        {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            var filePath = Path.Combine(_hostingEnvironment.WebRootPath,
                   _myConfig.NomePastaImagensLojas);
        ...
        public IActionResult GetImagens()
        {
            ...
            model.PathImagesLoja = _myConfig.NomePastaImagensLojas;
        ...
        public IActionResult Deletefile(string fname)
        {
            string _imagemDeleta = Path.Combine(_hostingEnvironment.WebRootPath,
                _myConfig.NomePastaImagensLojas + "\\", fname);
